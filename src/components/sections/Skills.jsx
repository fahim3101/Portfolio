        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {profile.skills.map((group, i) => (
            <motion.div
              ...
              className="bg-surface dark:bg-surface-d border border-border dark:border-border-d rounded-xl p-5"
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-display font-semibold text-lg text-ink dark:text-ink-d">{group.category}</h3>
                <span className="font-mono text-xs text-ink-faint dark:text-ink-faint-d">{group.hash}</span>
              </div>
